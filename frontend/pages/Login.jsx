  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: "0 20px 60px rgba(0,0,0,0.2)", width: "100%", maxWidth: "400px"
      }}>
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          <div style={{ fontSize: "60px" }}>🎓</div>
          <h2 style={{ margin: "8px 0", color: "#333", fontSize: "28px" }}>GradeHub</h2>
        ...
        {message && (
          <div style={{
            marginTop: "16px", padding: "12px", background: "#fdecea",
            borderRadius: "8px", color: "#c62828", textAlign: "center"
          }}>
            {message}
          </div>
        )}
